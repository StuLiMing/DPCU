...
class GaussianDiffusion:
    ...
    def encode_first_stage(self, y, first_stage_model, up_sample=False):
        ...
        if up_sample and self.sf != 1:
            y = F.interpolate(y, scale_factor=(4.,1.), mode='bicubic')
    ...
    def training_losses(
        ...
        # z_y = F.interpolate(y, scale_factor=(4.,1.), mode='nearest')
        z_y=y
        z_start=x_start
